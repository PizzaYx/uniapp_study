  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        g: common_vendor.s("height:" + navHeight.value + "rpx;" + containerStyle.value)
      }), {
        h: __props.titleText
      }, __props.titleText ? {
        i: common_vendor.t(__props.titleText),
        j: common_vendor.s("height:" + navHeight.value + "rpx;line-height:" + navHeight.value + "rpx;" + textStyle.value)
      } : {});
    };
  }
};
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/yx/Documents/uniappProject/uniapp_study/components/navbar/navbar.vue"]]);
