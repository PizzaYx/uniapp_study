<template>
	...
	<uni-popup ref="popup" type="center" :is-mask-click="false" background-color="#fff">
		<view class="popup-content">
			...
			<view class="group">
				<input class="uni-input" type="text" v-model="validMobile.validCode" placeholder="验证码" />
...
<script setup>
    ...
    app.globalData.utils.request({
      ...
      method: 'POST',
      data: { tel: validMobile.phone, code: validMobile.validCode },
      success: (res) => {
        //将Token 缓存
